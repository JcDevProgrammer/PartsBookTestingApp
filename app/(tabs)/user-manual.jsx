...
export default function UserManualScreen() {
  ...
  const documents = [
    ...
    { id: "3", category: "Instruction manual", name: "S-7300A Instruction manual" },
...
const styles = StyleSheet.create({
  ...
  sidebarItem: { paddingVertical: 15, borderBottomWidth: 1, borderBottomColor: "#b3b3b3" },
  ...
  categoryTitle: { fontSize: 14, fontWeight: "bold", color: "#666", marginBottom: 5 },
  downloadButton: { flexDirection: "row", alignItems: "center", padding: 10, backgroundColor: "#fff", borderRadius: 5 },
